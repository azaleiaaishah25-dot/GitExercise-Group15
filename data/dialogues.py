...
dialogue_data = {
    ...
    # ===========================
    # 1920s NPC 2: Rich Gentleman
    # ===========================
    "rich_gentleman": {
        "dialogue": [
            {"speaker": "RICH GENTLEMAN", "text": "..Hmm."},
            {"speaker": "PLAYER", "text": "..Excuse me?"},
            {"speaker": "RICH GENTLEMAN", "text": "Hold still."},
            {"speaker": "PLAYER", "text": "...What?"},
            {"speaker": "RICH GENTLEMAN", "text": "..That stitching. That cut."},
            {"speaker": "RICH GENTLEMAN", "text": "You remind me of someone."},
            {"speaker": "PLAYER", "text": "I do?"},
            {"speaker": "RICH GENTLEMAN", "text": "Yes.. a young man."},
            {"speaker": "RICH GENTLEMAN", "text": "Always asking questions about garments.. about time."},
            {"speaker": "PLAYER", "text": "..Time?"},
            {"speaker": "RICH GENTLEMAN", "text": "He said clothing tells stories."},
    ...
    "fashion_enthusiast": {
        "dialogue": [
            ...
            {"speaker": "FASHION ENTHUSIAST", "text": "She was holding something strange."},
            {"speaker": "PLAYER", "text": "What kind of item?"},
            {"speaker": "FASHION ENTHUSIAST", "text": "A shirt."},
            {"speaker": "FASHION ENTHUSIAST", "text": "Loose.. patterned.."},
            {"speaker": "FASHION ENTHUSIAST", "text": "Not fitted like anything here."},
            {"speaker": "CLUE", "text": "Clue discovered: Flannel Shirt"},
            {"speaker": "PLAYER", "text": "Where did she go?"},
            {"speaker": "FASHION ENTHUSIAST", "text": "Toward the back."},
            {"speaker": "FASHION ENTHUSIAST", "text": "Near the storage racks."},
        ],
